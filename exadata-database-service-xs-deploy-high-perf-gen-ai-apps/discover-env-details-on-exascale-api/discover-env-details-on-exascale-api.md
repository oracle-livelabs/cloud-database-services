...
## Task 2: List the available Pluggable Databases (PDBs) in a Container Database (CDB) using REST API 
...
## Task 3: Create Thin Clone of Pluggable Database (PDB) using REST API
...
## Task 4: List the available Updates for Database Homes in a specified compartment using OCI CLI
...
## Task 5: Apply Database Home Updates using OCI CLI
