...
## Task 1: List the available Exascale VM Cluster using REST API with OCI CLI 
...
2. From the Cloud Shell terminal, make an OCI REST API call to get a list of the available Exascale VM Cluster. 
   
   Get your **Compartment OCID** and **Exascale VM Cluster OCID** by running the command below:
  ...
  ![list compartment and vmcluster id](./images/display-compartment-vmcluster-id.png "list compartment and vmcluster id")
    ...
    > **Note:** Enter the name of your **VM Cluster** for example,  "***MyDemoVMClusterXX***"
...
3. Check the lifecycle state of the Exascale VM Cluster by running the REST API **OCI RAW-REQUEST** command below:
  ...
  ![check lifecycle state](./images/list-comp-vmcluster.png "check lifecycle state") 
    ...
    > **Note:** paste the OCID of your **assigned VM Cluster** obtained from ***Task 1 Step 2***
...
1. From the Cloud Shell terminal, make an OCI REST API call to get a list of the available updates for a specified Exascale VM Cluster by running the **OCI RAW-REQUEST** command below:
  ...
  ![list vmcluster udpates](./images/list-vmcluster-updates-command.png "list vmcluster udpates") 
    ...
    > **Note:** paste the OCID of your **VM Cluster** obtained from ***Task 1 Step 2***
...
1. Get your **Compartment OCID** and **Exascale VM Cluster OCID** by running the command below:
...
2. From the Cloud Shell terminal, make an OCI REST API call to get a list of the available Database Homes in a compartment by running the **OCI RAW-REQUEST** command below:
    ...
    Paste the OCID of your **Compartment** obtained from ***Step 1***.
