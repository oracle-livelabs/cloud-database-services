...
This workshop is designed to provide you with hands-on experience using the Oracle Exadata Database Service on Exascale Infrastructure.  
...
* Intelligent AI: The combination of AI Smart Scan with Exadata System Software offloads key AI Vector Search operations to the Exascale intelligent storage cloud, enabling massive amounts of vector data to be searched up to 30X faster.
...
* **Last Updated By** - Leo Alvarado, Product Management, Jan 2026.
